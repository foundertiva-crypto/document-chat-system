...
export function LandingPageClient() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className={`sticky ${donationBannerVisible ? 'top-[0px]' : 'top-0'} z-40 px-4 lg:px-6 h-14 flex items-center border-b bg-white/95 dark:bg-gray-950/95 backdrop-blur supports-[backdrop-filter]:bg-white/95 dark:supports-[backdrop-filter]:bg-gray-950/95 transition-all duration-300`}>
