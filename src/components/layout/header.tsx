...
export function Header({ onMobileMenuToggle, showNavigation = true, donationBannerVisible = true }: HeaderProps) {
  ...
  return (
    <header className={`sticky ${donationBannerVisible ? 'top-[52px]' : 'top-0'} z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 transition-all duration-300`}>
